...
public class FutureValueFrame extends javax.swing.JFrame {
    ...
    private void calculateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculateButtonActionPerformed
        if (isValidData())
        {
            double payment = Double.parseDouble(monthlyPaymentTextField.getText());
            double rate = Double.parseDouble(yearlyInterestRateTextField.getText());
...
private boolean isValidData()
{
    ...
    return
        ...
        sv.isPresent(yearlyInterestRateTextField, "Interest Rate") &&
        sv.isDouble(yearlyInterestRateTextField, "Interest Rate") &&
